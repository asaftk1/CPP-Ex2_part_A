...
int main() {
  // Create two players with their names 
   ...
   game.printLastTurn(); // print the last turn stats. For example:
                       ...
                       // Alice played 6 of Hearts Bob played 6 of Spades. Draw. Alice played 10 
                      //of Clubs Bob played 10 of Diamonds. draw. Alice played Jack of Clubs Bob 
                     //played King of Diamonds. Bob wins.
   ...
   game.printLog(); // prints all the turns played one line per turn (same printWinerformat as game.printLastTurn())
